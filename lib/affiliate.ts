 ...
 *
 * Affiliate params are disabled for now — links go straight to the
 * store search/product page without any tracking tags.
 */
export function getAffiliateLink(
  ...
  // Unknown store — fall back to Steam search
